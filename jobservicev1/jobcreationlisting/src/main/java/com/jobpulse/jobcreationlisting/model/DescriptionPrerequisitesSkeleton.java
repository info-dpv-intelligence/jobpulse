...
@AllArgsConstructor
@Entity
@Table(name = "description_prerequisites_skeleton")
public class DescriptionPrerequisitesSkeleton {
    @Id
    @Column(name = "description_prerequisites_skeleton_id", nullable = false)
    private UUID id;
